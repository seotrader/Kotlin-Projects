...
import com.giladdev.wowchat.UI.Activities.ChatActivity
import com.giladdev.wowchat.UI.Activities.ProfileActivity
...
class UsersAdaptor(databaseQuerty : DatabaseReference,
                   var context: Context,
                   var options: FirebaseRecyclerOptions<Users>) : FirebaseRecyclerAdapter<Users, UsersAdaptor.ViewHolder>(options) {
